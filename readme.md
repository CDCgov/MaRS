...
Please see the Illumina TADS [Lab Protocol](https://github.com/CDCgov/MaRS/blob/goat_dev/SOPs/MaRSsop_v50.md) for the most up to date standard operating procedures (SOPs).
